...
const navigation = [
  ...
  { name: 'Dash', href: '/Dashboard', current: false },
...
export default function Header() {
  ...
  const userData = {
    ...
    imageUrl: auth ?.user?.avatar 
      ?? "https://yt3.ggpht.com/ytc/AKedOLQdlpe31mHzbnXIBmJYq_pSIRXtDIhbV-ihgvFq=s900-c-k-c0x00ffffff-no-rj",
  };

return ( <>
<Disclosure as="nav" className="bg-blueGray-900 relative z-50">
  { ({ open })=> ( <>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between h-16">
        <div className="flex items-center">
          ...
          <Link href="/Login">
            <a>
              <img className="h-8 w-8" alt="Workflow" 
        ...
        <div className="hidden md:block">
          <div className="ml-4 flex items-center md:ml-6">
            <button type="button" className="bg-gray-800 p-1 
