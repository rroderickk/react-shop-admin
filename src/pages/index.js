...
export default function Home() { return (
  <div className="relative bg-white overflow-hidden z-0 lg:-mt-10"> <div className=" max-w-7xl mx-auto">
      <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 
        lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32"
      >
        <svg className="hidden lg:block absolute right-0 
          inset-y-0 h-full w-48 text-white transform translate-x-1/2"
          ...
          >
            ...
            >
              <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <a href="#" className="block w-full px-5 py-3 
                  text-center font-medium text-indigo-600 
        ...
        <main className="mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 
          backdrop-blur-xl bg-slate-100 rounded-xl shadow-xl"
        >
          <div className="sm:text-center lg:text-left p-8">
    ...
    <div className="lg:absolute lg:m-4 lg:inset-y-0 lg:right-0 lg:w-1/2 rounded-lg p-4 shadow-lg z-0">
      <img className="h-56 w-full object-cover sm:h-72 md:h-96
